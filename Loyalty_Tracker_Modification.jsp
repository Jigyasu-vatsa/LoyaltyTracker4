...
<form name="sampleform" action="Loyalty_Tracker_Modification.jsp" method="post">
		...
		if(Bnk!=null||!Bnk.equals(""))
{
	...
	//out.println(""+)
		...
		<center>
				<h2 style='border-bottom-style: solid;color: darkblue'>  Loyalty Modification File Upload Tracker - <%out.println(Bnk);%><br>  <hr></h2> </center>
